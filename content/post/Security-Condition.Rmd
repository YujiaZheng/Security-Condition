...
In the graph of the distribution of security score for buildings, we find that the distribution of security score is heavily left skewed. The distribution of the number of evaluated areas is also left skewed, with majority of the datapoints located between 15 to 19.
The findings are consistent with the summary statistics of SECURITY and NO_OF_AREAS_EVALUATED. 
